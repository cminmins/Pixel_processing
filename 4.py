...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Button_open.setGeometry(QtCore.QRect(1790, 20, 71, 31))
        self.Button_open.setObjectName("Button_open")
        self.List_directory = QtWidgets.QListWidget(self.centralwidget)
        self.List_directory.setGeometry(QtCore.QRect(1790, 60, 91, 541))
        self.List_directory.setObjectName("List_directory")
        self.qlabel_CT_crop = QtWidgets.QLabel(self.centralwidget)
        self.qlabel_CT_crop.setGeometry(QtCore.QRect(530, 10, 400, 600))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
        ...
        self.qlabel_MR_crop.setGeometry(QtCore.QRect(1370, 10, 400, 600))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
        ...
        self.qlabel_overay.setGeometry(QtCore.QRect(950, 420, 400, 600))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
        ...
        self.List_CT.setGeometry(QtCore.QRect(1370, 620, 511, 191))
        self.List_CT.setObjectName("List_CT")
        self.List_MR = QtWidgets.QListWidget(self.centralwidget)
        self.List_MR.setGeometry(QtCore.QRect(1370, 830, 511, 191))
        self.List_MR.setObjectName("List_MR")
        self.Button_save = QtWidgets.QPushButton(self.centralwidget)
        self.Button_save.setGeometry(QtCore.QRect(1080, 320, 101, 31))
        self.Button_save.setObjectName("Button_save")
        self.Button_CT1 = QtWidgets.QPushButton(self.centralwidget)
        self.Button_CT1.setGeometry(QtCore.QRect(950, 370, 101, 31))
        self.Button_CT1.setObjectName("Button_CT1")
        self.Button_CTMR = QtWidgets.QPushButton(self.centralwidget)
        self.Button_CTMR.setGeometry(QtCore.QRect(1080, 370, 101, 31))
        self.Button_CTMR.setObjectName("Button_CTMR")
        self.Button_MR1 = QtWidgets.QPushButton(self.centralwidget)
        self.Button_MR1.setGeometry(QtCore.QRect(1220, 370, 101, 31))
        self.Button_MR1.setObjectName("Button_MR1")
        self.horizontalSlider_2 = QtWidgets.QSlider(self.centralwidget)
        self.horizontalSlider_2.setGeometry(QtCore.QRect(1170, 20, 160, 22))
        self.horizontalSlider_2.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_2.setObjectName("horizontalSlider_2")
        self.verticalSlider_2 = QtWidgets.QSlider(self.centralwidget)
        self.verticalSlider_2.setGeometry(QtCore.QRect(1310, 50, 22, 160))
        self.verticalSlider_2.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_2.setObjectName("verticalSlider_2")
        self.graphics_CT = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphics_CT.setGeometry(QtCore.QRect(10, 10, 500, 500))
        self.graphics_CT.setObjectName("graphics_CT")
